...
export default function CreateToken() {
  ...
  async function createSale(url) {
    ...
    /* then list the item for sale on the gallery */
    contract = new ethers.Contract(nftgalleryaddress, NFTGallery.abi, signer)
    let listingPrice = await contract.getListingPrice()
    listingPrice = listingPrice.toString()

    transaction = await contract.createMarketItem(nftokenaddress, tokenId, price, { value: listingPrice })
